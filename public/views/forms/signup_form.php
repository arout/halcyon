...
<div class="row"> 
    ...
    <div class="col-md-6">
        <form id="signup" class="white-row" method="post" action="<?= BASEURL; ?>member/signup_validate">
    ...
    <div class="col-md-6">
        <div class="white-row">
            ...
            <p class="white-row text-center styleBackground"> Already have an account? <a href="<?= BASEURL; ?>login">Member Login</a> </p>
        </div>
    </div>
