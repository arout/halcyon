...
<section class="container">
  <div class="row">
    ...
    <!-- LOGIN -->
    <div>
      <form class="white-row" method="post" action="<?=BASEURL . 'login/login_validate';?>">
...
if (strpos($_SERVER['REQUEST_URI'], 'login/index/error')) {
    ...
    <div class="col-md-5 white-row">
      ...
      <div class="white-row">
        ...
        <h6>Email Address</h6>
        <form class="input-group" method="post" action="<?=BASEURL;?>login/forgot_password">
      ...
      <p class="white-row text-center styleBackground"> Need an account? <a href="<?=BASEURL;?>member/signup">Register now</a> </p>
    </div>
    <!-- /PASSWORD -->
