<section class="container">
    <div class="row">
        <div class="col-md-9">
            <h2> <strong>Oops</strong>, This Page Could Not Be Found!<br />
                <br />
                <?php
							...
							<div class="console">
								...
								<span>Developer note: Invalid controller <code>'.$route->controller.'</code> requested. This will trigger a 404 Not Found error.<br>
								...
								If the url segment named <strong>'.str_replace('_Controller', '', $route->controller).'</strong> is correct, 
								you should have a controller file named <strong>'.$route->controller.'.php</strong> inside of your /public/controllers directory, 
        ...
        <aside class="col-md-3 white-row styleBackground">
