...
function apc() {
	...
	if (extension_loaded('apc')) {
		...
		echo '<td class="alert alert-danger">Not enabled. This is not a fatal error. APC is optional; the system uses it as a fallback in case Opcache is not available. You still use kW Fusion</td>';
...
function continue_install() {
	...
	if (array_key_exists('HTTP_MOD_REWRITE', $_SERVER) & $php >= 5.5) {
		echo '<div class="row alert alert-success text-center"><h3>Installation may continue</h3>Next, open the Config.php file, located in <span class="red">' . BASEPATH . 'vendor/Fusion/Config/Config.php</span>, and edit your site settings before using kW Fusion.</div>';
	} else {

		echo '<div class="row alert alert-danger text-center"><h3>kW Fusion cannot be run on this system</h3>Please review the chart above to review and correct errors.</div>';
	}
}
...
function memcached() {
	...
	if (extension_loaded('memcached')) {
		...
		echo '<td class="alert alert-warning">Could not connect to Memcache server. Please confirm that you have Memcached installed, and that it is running.
            ...
            This is not a fatal error. You may still use kW Fusion; however, to improve the scalability of your website as it attracts higher amounts
...
function php_ver() {
	...
	if ($php >= 5.5) {
		...
		echo '<td class="alert alert-danger">Installation cannot continue. You must have PHP version 5.5 or higher.
        ...
        <div class="row">
            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 margin-bottom-none">
                <div class="flip margin-bottom-30">
                    <div class="card">
                        <div class="face front"><img class="img-responsive" src="<?=TEMPLATE_URL;?>assets/images/car1.jpg" alt=""></div>
                        <div class="face back">
                            <div class='hover_title'>Race Ready</div>
                            <a href="<?=BASEURL;?>inventory/"><i class="fa fa-link button_icon"></i></a>
                            <a href="<?=TEMPLATE_URL;?>assets/images/car1-lrg.jpg" class="fancybox"><i class="fa fa-arrows-alt button_icon"></i></a> </div>
                    </div>
                </div>
            ...
            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 margin-bottom-none">
                <div class="flip horizontal margin-bottom-30">
                    <div class="card">
                        <div class="face front"><img class="img-responsive" src="<?=TEMPLATE_URL;?>assets/images/car2.jpg" alt=""></div>
                        <div class="face back">
                            <div class='hover_title'>Family Oriented</div>
                            <a href="<?=BASEURL;?>inventory/"><i class="fa fa-link button_icon"></i></a> <a href="<?=TEMPLATE_URL;?>assets/images/car2-lrg.jpg" class="fancybox"><i class="fa fa-arrows-alt button_icon"></i></a> </div>
                    </div>
                </div>
            ...
            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 margin-bottom-none">
                <div class="flip margin-bottom-30">
                    <div class="card">
                        <div class="face front"><img class="img-responsive" src="<?=TEMPLATE_URL;?>assets/images/car3.jpg" alt=""></div>
                        <div class="face back">
                            <div class='hover_title'>World Class</div>
                            <a href="<?=BASEURL;?>inventory/"><i class="fa fa-link button_icon"></i></a> <a href="<?=TEMPLATE_URL;?>assets/images/car3-lrg.jpg" class="fancybox"><i class="fa fa-arrows-alt button_icon"></i></a> </div>
                    </div>
                </div>
...
<div class="row parallax_parent design_2 margin-bottom-40 margin-top-30">
    <div class="parallax_scroll clearfix" data-velocity="-.5" data-offset="-200" data-image="<?=TEMPLATE_URL;?>assets/images/parallax1.jpg">
        <div class="overlay">
            <div class="container">
                <div class="row">
        ...
        <div class="row">
            ...
            <div class="col-md-10 col-sm-8 padding-right-none xs-padding-left-none">
                <div class="carasouel-slider3">
                    <div class="slide">
                        <div class="car-block">
                            <div class="img-flex"> <a href="<?=BASEURL;?>inventory/"><span class="align-center"><i class="fa fa-3x fa-plus-square-o"></i></span></a> <img src="<?=TEMPLATE_URL;?>assets/images/c-car1.jpg" alt="" class="img-responsive"> </div>
                    ...
                    <div class="slide">
                        <div class="car-block">
                            <div class="img-flex"> <a href="<?=BASEURL;?>inventory/"><span class="align-center"><i class="fa fa-3x fa-plus-square-o"></i></span></a> <img src="<?=TEMPLATE_URL;?>assets/images/c-car2.jpg" alt="" class="img-responsive"> </div>
                            <div class="car-block-bottom">
                    ...
                    <div class="slide">
                        <div class="car-block">
                            <div class="img-flex"> <a href="<?=BASEURL;?>inventory/"><span class="align-center"><i class="fa fa-3x fa-plus-square-o"></i></span></a> <img src="<?=TEMPLATE_URL;?>assets/images/c-car3.jpg" alt="" class="img-responsive"> </div>
                            <div class="car-block-bottom">
                    ...
                    <div class="slide">
                        <div class="car-block">
                            <div class="img-flex"> <a href="<?=BASEURL;?>inventory/"><span class="align-center"><i class="fa fa-3x fa-plus-square-o"></i></span></a> <img src="<?=TEMPLATE_URL;?>assets/images/c-car4.jpg" alt="" class="img-responsive"> </div>
                            <div class="car-block-bottom">
                    ...
                    <div class="slide">
                        <div class="car-block">
                            <div class="img-flex"> <a href="<?=BASEURL;?>inventory/"><span class="align-center"><i class="fa fa-3x fa-plus-square-o"></i></span></a> <img src="<?=TEMPLATE_URL;?>assets/images/c-car5.jpg" alt="" class="img-responsive"> </div>
                            <div class="car-block-bottom">
                    ...
                    <div class="slide">
                        <div class="car-block">
                            <div class="img-flex"> <a href="<?=BASEURL;?>inventory/"><span class="align-center"><i class="fa fa-3x fa-plus-square-o"></i></span></a> <img src="<?=TEMPLATE_URL;?>assets/images/c-car6.jpg" alt="" class="img-responsive"> </div>
                            <div class="car-block-bottom">
                    ...
                    <div class="slide">
                        <div class="car-block">
                            <div class="img-flex"> <a href="<?=BASEURL;?>inventory/"><span class="align-center"><i class="fa fa-3x fa-plus-square-o"></i></span></a> <img src="<?=TEMPLATE_URL;?>assets/images/c-car7.jpg" alt="" class="img-responsive"> </div>
                            <div class="car-block-bottom">
                    ...
                    <div class="slide">
                        <div class="car-block">
                            <div class="img-flex"> <a href="<?=BASEURL;?>inventory/"><span class="align-center"><i class="fa fa-3x fa-plus-square-o"></i></span></a> <img src="<?=TEMPLATE_URL;?>assets/images/c-car8.jpg" alt="" class="img-responsive"> </div>
                            <div class="car-block-bottom">
                    ...
                    <div class="slide">
                        <div class="car-block">
                            <div class="img-flex"> <a href="<?=BASEURL;?>inventory/"><span class="align-center"><i class="fa fa-3x fa-plus-square-o"></i></span></a> <img src="<?=TEMPLATE_URL;?>assets/images/c-car9.jpg" alt="" class="img-responsive"> </div>
                            <div class="car-block-bottom">
...
<div class="row parallax_parent margin-top-30">
    <div class="parallax_scroll clearfix" data-velocity="-.5" data-offset="-300" data-no-repeat="true" data-image="<?=TEMPLATE_URL;?>assets/images/parallax2.jpg">
        <div class="overlay">
            <div class="container">
