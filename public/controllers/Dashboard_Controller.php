...
class Dashboard_Controller extends Hal\Core\SystemController {
	...
	function signup_validate() {
		...
		if ($check_if_valid === true) {
			...
			// NOTE THE []; $form must remain an array
			/*
			...
			$to = $this->config->setting('site_email');
			...
			// Additional headers
			$headers .= $this->config->setting('site_email') . "\r\n";
			$headers .= 'From: ' . $this->config->setting('site_name') . ' <' . $this->config->setting('site_email') . '>' . "\r\n";
