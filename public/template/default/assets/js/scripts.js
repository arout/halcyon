	...
	function _globalSearch() {
		...
		jQuery('li.search').bind("click", function() {
			...
			if(jQuery(this).hasClass('open')) {
				...
				jQuery('li.quick-cart, li.messenger').removeClass('open'); // close quick cart
		...
		jQuery(document).keydown(function(e) {
			...
			if(code == 27) {
				jQuery('li.search, li.messenger, li.quick-cart').removeClass('open');
				disable_overlay();
				enable_scroll();
			}
		});
 ...
 **************************************************************** **/
	function _quickCart() {
		...
		jQuery('li.messenger').bind("click", function() {

			jQuery('li.messenger .messenger-content').bind("click", function(e) {
				e.stopPropagation();
			});
		...
		jQuery(document).bind("click", function() {
			if(jQuery('li.messenger').hasClass('open')) {
				jQuery('li.search, li.messenger, li.quick-cart').removeClass('open');
				disable_overlay();
				enable_scroll();
			}
