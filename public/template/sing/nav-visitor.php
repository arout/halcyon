...
<nav id="sidebar" class="sidebar" role="navigation">
    ...
    <div class="js-sidebar-content">
        <header class="logo hidden-xs">
            <a href="<?=BASEURL;?>"><?=$this->config->setting('site_name');
?></a>
        </header>
        ...
        <div class="sidebar-status visible-xs">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                <span class="thumb-sm avatar pull-right">
                    <img class="img-circle" src="<?=TEMPLATE_URL;?>assets/demo/img/people/a5.jpg" alt="...">
                </span>
        ...
        <ul class="sidebar-nav">
            <li class="active">
                ...
                <ul id="sidebar-dashboard" class="collapse in">
                    <li class="active"><a href="<?=BASEURL;?>">Dashboard</a></li>
...
<nav class="page-controls navbar navbar-default">
    <div class="container-fluid">
        ...
        <div class="navbar-header">
            ...
            <!-- xs & sm screen logo -->
            <a class="navbar-brand visible-xs" href="<?=BASEURL;?>">
                        ...
                        <section class="panel notifications">
                            ...
                            <div id="notifications-list" class="list-group thin-scroll">
                                ...
                                <span class="thumb-sm pull-left mr clearfix">
                                    <img class="img-circle" src="<?=TEMPLATE_URL;?>assets/demo/img/people/a3.jpg" alt="...">
                                </span>
...
&nbsp;
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a href="#">Inbox &nbsp;
&nbsp;
<span class="badge bg-danger animated bounceIn">9</span></a></li>
                        <li class="divider"></li>
                ...
                <li>
                    ...
                    <div id="chat-notification" class="chat-notification hide">
                        <div class="chat-notification-inner">
                            <h6 class="title">
                                <span class="thumb-xs">
                                    <img src="<?=TEMPLATE_URL;?>assets/demo/img/people/a6.jpg" class="img-circle mr-xs pull-left">
                                </span>
                                Jess Smith
                            </h6>
        ...
        <div class="chat-sidebar-contacts chat-sidebar-panel open">
            ...
            <div class="list-group chat-sidebar-user-group">
                <a class="list-group-item" href="#chat-sidebar-user-1">
                    ...
                    <span class="thumb-sm pull-left mr">
                        <img class="img-circle" src="<?=TEMPLATE_URL;?>assets/demo/img/people/a2.jpg" alt="...">
                    </span>
                ...
                <span class="thumb-sm pull-left mr">
                    <img class="img-circle" src="<?=TEMPLATE_URL;?>assets/img/avatar.png" alt="...">
                </span>
                ...
                <span class="thumb-sm pull-left mr">
                    <img class="img-circle" src="<?=TEMPLATE_URL;?>assets/demo/img/people/a1.jpg" alt="...">
                </span>
                ...
                <a class="list-group-item" href="#chat-sidebar-user-5">
                    <i class="fa fa-circle text-success pull-right"></i>
                <span class="thumb-sm pull-left mr">
                    <img class="img-circle" src="<?=TEMPLATE_URL;?>assets/demo/img/people/a4.jpg" alt="...">
                </span>
            ...
            <div class="list-group chat-sidebar-user-group">
                <a class="list-group-item" href="#chat-sidebar-user-6">
                    <i class="fa fa-circle text-gray-light pull-right"></i>
                <span class="thumb-sm pull-left mr">
                    <img class="img-circle" src="<?=TEMPLATE_URL;?>assets/demo/img/people/a6.jpg" alt="...">
                </span>
