...
<div class="back_to_top"> <img src="<?=TEMPLATE_URL;?>assets/images/arrow-up.png" alt="scroll up" /> </div>
<!-- Bootstrap core JavaScript -->
<script src="<?=TEMPLATE_URL;?>assets/js/retina.js"></script>
<script type="text/javascript" src="<?=TEMPLATE_URL;?>assets/js/jquery.parallax.js"></script>
<script type="text/javascript" src="<?=TEMPLATE_URL;?>assets/js/jquery.inview.min.js"></script>
<script src="<?=TEMPLATE_URL;?>assets/js/main.js"></script>
<script type="text/javascript" src="<?=TEMPLATE_URL;?>assets/js/jquery.fancybox.js"></script>
<script src="<?=TEMPLATE_URL;?>assets/js/modernizr.custom.js"></script>
<script defer src="<?=TEMPLATE_URL;?>assets/js/jquery.flexslider.js"></script>
<script src="<?=TEMPLATE_URL;?>assets/js/jquery.bxslider.js" type="text/javascript"></script>
<script src="<?=TEMPLATE_URL;?>assets/js/jquery.selectbox-0.2.js" type="text/javascript"></script>
<script type="text/javascript" src="<?=TEMPLATE_URL;?>assets/js/jquery.mousewheel.js"></script>
<script type="text/javascript" src="<?=TEMPLATE_URL;?>assets/js/jquery.easing.js"></script>
