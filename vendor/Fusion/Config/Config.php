...
/**
 * File:    /vendor/Fusion/Config/Config.php
 * Purpose: Main configuration file for site-wide settings
 */
...
class Config {
	...
	public function __construct() {
		...
		# Database Connection
		$this->setting['db_host'] = "localhost";	// Location of database; normally localhost
		...
		$this->setting['default_controller'] = 'Welcome_Controller';
		...
		$this->setting['template_name'] = 'sing';
